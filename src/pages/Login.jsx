      ...
      <div>
        ...
        <div className="space-y-3">
          ...
          >
            ...
            <span className="text-gray-700 font-medium">Log in with GitHub</span>
          </button>

          <button
            onClick={handleSSOLogin}
            className="w-full px-4 py-2.5 border border-gray-300 rounded-md hover:bg-gray-50 transition-all text-gray-700 font-medium"
          >
